...
class Grafite {
    ...
    /**
     * HashMap é uma estrutura que armazena valores chave/valor
     * No caso, para testes resolvi usá-lo para armzenas os tipos de durezas
     * e suas respectivas durabilidades - (tipo, durabilidade)
     */
    static HashMap<String, Integer> tiposDurezas = new HashMap<String, Integer>();
    
	/**
	 * static {} é um bloco de codigo que será executado quando a classe é carregada 
	 * OBS: ele só é executado uma vez e não pode ser excutado por outros metodos
